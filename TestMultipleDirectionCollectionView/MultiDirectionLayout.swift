...
import UIKit
protocol MultiDirectionLayoutDelegate: class {
...
class MultiDirectionLayout: UICollectionViewLayout {
    ...
    var delegate: MultiDirectionLayoutDelegate?
    ...
    override func prepare() {
        ...
        if attributeCache.isEmpty {
            ...
            xOffsets = [CGFloat](repeating: collectionViewCenter, count: Int(numberOfColumns))
